...
{
    /// <summary>
    /// Retrieves system icons and converts them to proper bitmap format for display in the application.
    /// </summary>
    public class Icons
    {
        /// <summary>
        /// Returns ImageSource for the specified file path/name/extension.
        /// </summary>
